...
function ageInDays(){
  ...
  var ageInDayz = (2018 - birthYear) * 365;
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage){
  ...
  humanDiv.innerHTML = "<img src='" + imagesDatabase[humanImageChoice] + "'height=150 width=150 style='box-shadow: 0px 10px 50px rgb(0, 232, 240);'>"
...
function showCard(card, activePlayer) {
  if (activePlayer['score'] <= 21){
   ...
   cardImage.src = `static/Images/blackjackimages/${card}.png`;
